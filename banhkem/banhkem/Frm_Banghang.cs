...
namespace banhkem
{
    public partial class Frm_Banghang : Form
    {
        ...
        private void txtSTK_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (!Char.IsDigit(e.KeyChar) && !Char.IsControl(e.KeyChar)) // Chỉ được quyền nhập số ở textbox txtSTK này.
            {
                e.Handled = true;
        ...
        private void txtTuKhoa_TextChanged(object sender, EventArgs e)
        {
            ...
            int index = 0;
            if (txtTuKhoa.Text == "" && cbLoai_BanhKem.Text == "")
            {
            ...
            else
            {
                ...
                foreach (SanPham sanpham in listSP)
                {
                    ...
                    string name_temp = sanpham.TenSP.ToLower();// chuyen ve ky tu thuong. Ta tra san pham co ky tu thuong & hoa.
                    ...
                    if (name_temp.Contains(string_temp) && sanpham.Size == cbLoai_BanhKem.Text )
                    {
                        int stt = index + 1;
                        lstProduct.Items.Add(stt.ToString());
                        lstProduct.Items[index].SubItems.Add(sanpham.TenSP);
                    ...
                    {
                        if (name_temp.Contains(string_temp) && cbLoai_BanhKem.Text == "All")
                        {
                            int stt = index + 1;
                            lstProduct.Items.Add(stt.ToString());
                            lstProduct.Items[index].SubItems.Add(sanpham.TenSP);
